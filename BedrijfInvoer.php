...
<html>
  ...
  <script type="text/javascript">
    function Edit(BedrijfId, BedrijfsNaam, BedrijfsEmail, BedrijfsInfo, BedrijfsAdres, BedrijfsTel, BedrijfsWebsite, BedrijfsContactPer, AantalPersoneel, StageO, StageB, StageE, LeerRichting, Grote, Werkzaamheden, Begeleiding, BedrijfsP2, KlantenOmgang) {
      ...
      if (Grote == 0) { Grote = document.getElementById("Grote0"); Grote.checked = true; }
      else if (Grote == 1) { Grote = document.getElementById("Grote1"); Grote.checked = true; }
      else if (Grote == 2) { Grote = document.getElementById("Grote2"); Grote.checked = true;}

      if (Werkzaamheden == "0") { Werkzaamheden = document.getElementById("Werkzaamheden0"); Werkzaamheden.checked = true; }
      else if (Werkzaamheden == "1") { Werkzaamheden = document.getElementById("Werkzaamheden1"); Werkzaamheden.checked = true; }
      else if (Werkzaamheden == "2") { Werkzaamheden = document.getElementById("Werkzaamheden2"); Werkzaamheden.checked = true; }
      else if (Werkzaamheden == "3") { Werkzaamheden = document.getElementById("Werkzaamheden3"); Werkzaamheden.checked = true; }
      else if (Werkzaamheden == "4") { Werkzaamheden = document.getElementById("Werkzaamheden4"); Werkzaamheden.checked = true; }

      if (Begeleiding == "0") { Zelfstandigheid = document.getElementById("Zelfstandigheid0"); Zelfstandigheid.checked = true; }
      else if (Begeleiding == "1") { Zelfstandigheid = document.getElementById("Zelfstandigheid1"); Zelfstandigheid.checked = true; }
      else if (Begeleiding == "2") { Zelfstandigheid = document.getElementById("Zelfstandigheid2"); Zelfstandigheid.checked = true; }

      if (BedrijfsP2 == "0") { Profiel2 = document.getElementById("Profiel20"); Profiel2.checked = true; }
      else if (BedrijfsP2 == "1") { Profiel2 = document.getElementById("Profiel21"); Profiel2.checked = true; }

      if (KlantenOmgang == "0") { Klanten = document.getElementById("Klanten0"); Klanten.checked = true; }
      else if (KlantenOmgang == "1") { Klanten = document.getElementById("Klanten1"); Klanten.checked = true; }
      else if (KlantenOmgang == "2") { Klanten = document.getElementById("Klanten2"); Klanten.checked = true; }
      else if (KlantenOmgang == "3") { Klanten = document.getElementById("Klanten3"); Klanten.checked = true; }
      else if (KlantenOmgang == "4") { Klanten = document.getElementById("Klanten4"); Klanten.checked = true; }
    }
          ...
          <div class="modal-content">
            ...
            <div class="modal-body ">
              <div class="row">
                ...
                <div class="col-sm-7">
                  <input required type="values" readonly name="bedrijfEditId" id="bedrijfEditId" style="width: 25px; padding: 2px; text-align: center; color: gray; border: 1px solid gray; background-color: lightgray;">
                </div>
                <div class="col-sm-4" style="margin-right: 2%;">Naam van het bedrijf:&nbsp;</div>
                <div class="col-sm-7">
                  <input required type="values" name="bedrijfEditNaam" id="bedrijfEditNaam">
                </div>
                <br />
                <div class="col-sm-4" style="margin-right: 2%;">Email Bedrijf:&nbsp;</div>
                <div class="col-sm-7">
                  <input required type="email" name="bedrijfEditEmail" id="bedrijfEditEmail">
                </div>
                <br />
                <div class="col-sm-4" style="margin-right: 2%;">Info bedrijf:&nbsp;</div>
                <div class="col-sm-7">
                ...
                <div class="col-sm-4" style="margin-right: 2%;">Leerrichting van het bedrijf:&nbsp;</div>
                <div class="col-sm-7">
                  <select required name="bedrijfEditLeerrichting" id="bedrijfEditLeerrichting" style="width: 90%">
                    <option type="text" value="">-</option>
                    <option type="text" value="Logistics">Logistics</option>
                    <option type="text" value="ICT">ICT</option>
                    <option type="text" value="Bouw">Bouw</option>
