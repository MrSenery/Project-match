          ...
          <div class="modal-content">
            ...
            <div class="modal-body ">
              <div class="row">
                ...
                <div class="col-sm-4" style="margin-right: 2%;">Gebruikersnaam:&nbsp;</div>
                <div class="col-sm-7">
                  <input required type="values" name="docentEditGebruikersaam" id="docentEditGebruikersnaam">
                </div>
                <br />
                <div class="col-sm-4" style="margin-right: 2%;">Wachtwoord:&nbsp;</div>
                <div class="col-sm-7">
                  <input required type="password" name="docentEditWachtwoord" id="docentEditWachtwoord">
                </div>
                <br />
                <div class="col-sm-4" style="margin-right: 2%;">Naam van docent:&nbsp;</div>
                <div class="col-sm-7">
                  <input required type="values" name="docentEditNaam" id="docentEditNaam">
                </div>
                <br />
                <div class="col-sm-4" style="margin-right: 2%;">Achternaam:&nbsp;</div>
                <div class="col-sm-7">
                  <input required type="values" name="docentEditAchternaam" id="docentEditAchternaam">
                </div>
                <br />
                <div class="col-sm-4" style="margin-right: 2%;">Email docent:&nbsp;</div>
                <div class="col-sm-7">
                  <input required type="email" name="docentEditEmail" id="docentEditEmail">
                </div>
                <br />
                <div class="col-sm-4" style="margin-right: 2%;">Leerrichting van de docent:&nbsp;</div>
                <div class="col-sm-7">
                  <select required name="docentEditLeerrichting" id="docentEditLeerrichting" style="width: 90%">
                    <option type="text" value="">-</option>
                    <option type="text" value="Logistics">Logistics</option>
                    <option type="text" value="ICT">ICT</option>
                    <option type="text" value="Bouw">Bouw</option>
